...
public class C13_Get_ExpectedDataOlusturma {
    ...
    public void get01(){
        ...
        yolladigimizda donen response body'sinin sagida verilen ile ayni oldugunu test ediniz.

        Response body :
        {
        "userId":3,
        "id":22,
        "title":"dolar sint quo velit explicabo quia nam",
        "body":"eos qui et ipsum ipsam suscipit autsed omnis no odioexpedita earum mollitia molestiae aut atque rem suscipitnam impedit esse"
        }
         */

        // 1-Endpoin ve request body hazirla
